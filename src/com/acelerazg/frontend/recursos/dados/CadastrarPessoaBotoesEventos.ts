    ...
    public static cadastrarEmpresa() {
        ...
        if (formEmpresa != formEmpresa.getAttribute('hidden')) {
            ...
            formEmpresa.addEventListener('submit', function () {
                ...
                if (competencias.length === 0) {
                    formEmpresa.preventDefault();
                    alert('Selecione pelo menos uma competência.');
                }

                let empresaNome: any = document.getElementById('empresaNomeNome');
